...
{
    return (rc->get_radio_in() == 0)?0:(rc->get_reverse() ? -1 : 1) * (rc->get_radio_in() - rc->get_radio_min()) * (int32_t)(angle_max - angle_min) / (rc->get_radio_max() - rc->get_radio_min()) + (rc->get_reverse() ? angle_max : angle_min);
}
