...
float NavEKF3_core::faultScore(void) const
{
    float score = 0.0f;
...
void NavEKF3_core::getGyroScaleErrorPercentage(Vector3f &gyroScale) const
{
...
void NavEKF3_core::getAccelZBias(float &zbias) const {
    if (dtEkfAvg > 0) {
...
bool NavEKF3_core::getPosNED(Vector3f &pos) const
{
