...
void NavEKF3_core::setAidingMode()
{
    ...
    if (PV_AidingMode != PV_AidingModePrev) {
        ...
        if (PV_AidingMode == AID_NONE) {
            ...
            hal.console->printf("EKF3 IMU%u has stopped aiding\n",(unsigned)imu_index);
            ...
            hal.console->printf("EKF3 IMU%u is using optical flow\n",(unsigned)imu_index);
            posTimeout = true;
            velTimeout = true;
            ...
            hal.console->printf("EKF3 IMU%u is using GPS\n",(unsigned)imu_index);
            posTimeout = false;
            velTimeout = false;
...
void NavEKF3_core::setOrigin()
{
    ...
    validOrigin = true;
    hal.console->printf("EKF3 IMU%u Origin Set\n",(unsigned)imu_index);
}
