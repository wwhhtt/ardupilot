...
{
    // apply corrections for sensor bias errors and earth rotation rate
    // % * - and + operators have been overloaded
    Vector3f delAngCorrected = imuDataDelayed.delAng - stateStruct.gyro_bias - prevTnb * earthRateNED * imuDataDelayed.delAngDT;
    ...
    delVelNav  = prevTnb.mul_transpose(imuDataDelayed.delVel - stateStruct.accel_bias);
...
Vector3f NavEKF2_core::calcRotVecVariances()
{
    Vector3f rotVarVec;
...
void NavEKF2_core::initialiseQuatCovariances(Vector3f &rotVarVec)
{
